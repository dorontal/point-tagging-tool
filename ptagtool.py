...
class Application(Frame):
    ...
    def __init__(self, path, master=None):
        ...
        self.path = path
        self.lImgFilenames = FindImgFiles(path)
...
def FindImgFiles(path):
    ...
    def walker(path, lFilenames=[]):
        """Recursive file finder that follows symbolic links"""
        for strRoot, lDirs, lFiles in os.walk(path):
